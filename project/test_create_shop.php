...
if(isset($_POST["save"])){
    ...
    $stmt = $db->prepare("INSERT INTO test_create_shop (name, quantity, price, description, modified, next_stage_time, user_id) VALUES(:name, :amount, :cost, :desc,:mod,:nst,:user)");
    $r = $stmt->execute([
        ":name"=>$name,
        ":amount"=>$quantity,
        ":cost"=>$price,
