...
$dbuser = "esb23";//your ucid since we follow this pattern
$dbpass = "Flame1066!";//database password generated or chosen per respective steps
$dbdatabase = "esb23";//your ucid since we follow this pattern
?>
